 ...
 */
public class Seam22 extends Archive
{
   /** Class set */
   ...
   public Seam22()
   {
      super(ArchiveTypes.JAR, "Seam 2.2", ClassFile.JAVA_5, null, null, null, null, null, null, null, null);

      Location l = new Location("jboss-seam-2.2.0.GA.jar", "Seam 2.2");
      addLocation(l);
   }
