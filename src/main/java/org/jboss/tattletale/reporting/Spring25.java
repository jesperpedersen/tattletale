 ...
 */
public class Spring25 extends Archive
{
   /** Class set */
   ...
   public Spring25()
   {
      super(ArchiveTypes.JAR, "Spring 2.5", ClassFile.JAVA_4, null, null, null, null, null, null, null, null);

      Location l = new Location("spring.jar", "Spring 2.5");
      addLocation(l);
   }
