...
public class SunJava5JSSE extends Archive
{
   ...
   static
   {
      ...
      try
      {
         is = Thread.currentThread().getContextClassLoader().getResourceAsStream("sunjdk5-jsse.clz");
   ...
   public SunJava5JSSE()
   {
      super(ArchiveTypes.JAR, "Sun Java 5 (JSSE)", null, null, null, null, null, null);
